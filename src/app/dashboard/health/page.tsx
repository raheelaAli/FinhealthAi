              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-xs text-gray-400 border-b border-gray-100">
                    ...
                    <th className="text-center pb-2 font-medium">👟 Steps</th>
                    <th className="text-center pb-2 font-medium">😴 Sleep</th>
                    <th className="text-center pb-2 font-medium">💧 Water</th>
                    <th className="text-center pb-2 font-medium">Mood</th>
                    <th className="text-center pb-2 font-medium">⚖️ Weight</th>
                  </tr>
                </thead>
                <tbody>
                  {logs.slice(0, 10).map(log => (
                    <tr key={log.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50">
                      ...
                      <td className="py-2.5 text-center text-gray-800">
                        {log.sleepHrs ? `${log.sleepHrs}h` : "—"}
                      </td>
                      <td className="py-2.5 text-center text-gray-800">
                        {log.waterL ? `${log.waterL}L` : "—"}
                      </td>
                      <td className="py-2.5 text-center">
                        {log.mood ? moodEmoji[log.mood] : "—"}
                      </td>
                      <td className="py-2.5 text-center text-gray-800">
